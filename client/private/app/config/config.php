...
define("BASE_URL", "http://".$_local_ip."/project/attendence/client/");
...
/*ATVIN - FOR database cookie storage*/
$config['sess_save_path'] = 'ob_sessions';
/*$config['sess_expiration'] = 2592000;*//*30 Days*/
$config['sess_expiration'] = 0;/*No Expiry*/
